...
const translations = {
  fr: {
    ...
    'contact.date': 'Date souhaitée',
    'contact.time': 'Heure souhaitée',
    'contact.time.placeholder': 'Choisir un créneau',
    'contact.type': 'Type de rencontre',
    'contact.type.video': 'Appel vidéo',
    'contact.type.phone': 'Appel téléphonique',
    'contact.submit': 'Réserver ma consultation',
  ...
  en: {
    ...
    'contact.time.placeholder': 'Choose a time slot',
    'contact.type': 'Meeting type',
    'contact.type.video': 'Video call',
    'contact.type.phone': 'Phone call',
    'contact.submit': 'Book my consultation',
